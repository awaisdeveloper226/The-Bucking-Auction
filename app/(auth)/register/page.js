          ...
          {["firstName","lastName","cellPhone","emailAddress","physicalAddress"].map((field) => (
            <div key={field}>
              ...
              <input
                ...
                placeholder={`Enter your ${field.replace("cellPhone","cell phone").replace("emailAddress","email").replace("physicalAddress","address").replace("firstName","first name").replace("lastName","last name")}`}
                required
            ...
            {successData?.biddingNumber && (
              <>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  By accepting a bidding number, you acknowledge and agree to the Terms & Conditions of Buckers Auction as outlined on our website. Please note that these terms may be updated at any time without prior notice.
                </p>
              </>
            )}
            <button
