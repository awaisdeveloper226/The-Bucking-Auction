    ...
    <main className="min-h-screen bg-[#F5F8F7] text-gray-800">
      ...
      <section className="py-16 px-6 md:px-16">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition">
          ...
          />
          <div>
            <h2 className="text-3xl font-semibold text-[#0A0F2C] mb-4">
              Our Story
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              In 2025, Phil Markoff and Tenneile Rice of{" "}
              <Link
                href="https://trcattle.com"
                className="text-[#00AEB4] underline"
              >
                TR Cattle
              </Link>{" "}
              offered their yearling crop to the public for the first time. They
              spent countless hours preparing each calf for its future,
              ensuring every detail was perfect.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
              Phil believed Tenneile could market the cattle herself on
              Facebook, but Tenneile wanted a professional touch. After
              consulting their trusted friend Sonny Barthold, who endorsed the
              idea, Tenneile took the challenge and launched a highly successful
              auction, marketing every calf with precision.
            </p>
      ...
      <section className="py-16 px-6 md:px-16">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
          <div className="bg-[#F0FAFA] rounded-2xl shadow-lg p-8 hover:shadow-2xl transition">
            <h3 className="text-2xl font-semibold text-[#007A80] mb-3">
              Our Mission
            </h3>
            <p className="text-gray-600 leading-relaxed">
              To connect the{" "}
              <span className="font-semibold">best bulls and rodeo cows</span>{" "}
              with the best owners—people who will give them the opportunity to
              become champions or produce champions.
            </p>
          </div>
          <div className="bg-[#F0FAFA] rounded-2xl shadow-lg p-8 hover:shadow-2xl transition">
            <h3 className="text-2xl font-semibold text-[#1D4ED8] mb-3">
              Our Vision
            </h3>
            <p className="text-gray-600 leading-relaxed">
              Bucking bulls and rodeo cows are more than just animals; they’re
