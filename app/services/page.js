      ...
      <section className="bg-[#335566] text-white py-16">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-200 max-w-3xl mx-auto">
            At The Bucking Auction, we provide a seamless platform for buyers to
            connect through live auctions.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-3 gap-10">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 text-center border-t-4 border-[#6ED0CE] hover:shadow-2xl transition duration-300">
          ...
          <p className="text-gray-600">
            Experience the excitement of real-time bidding with live updates and
            a smooth user interface for buyers.
          </p>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 text-center border-t-4 border-[#6ED0CE] hover:shadow-2xl transition duration-300">
          ...
          <p className="text-gray-600">
            Track auctions you’re interested in, place bids instantly, and
            manage your bidder number in one place.
          </p>
        </div>
      </section>
